...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/fashion', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/healthtable'; // Navigate to HealthTable.jsx
//   };
...
const FashionForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/fashiontable'; // Navigate to HealthTable.jsx
  };
