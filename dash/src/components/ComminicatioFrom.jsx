...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/communication', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/commtable'; // Navigate to CommunicationTable.jsx
//   };
...
const CommunicationForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/commtable'; // Navigate to HealthTable.jsx
  };
