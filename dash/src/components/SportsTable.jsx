...
// import '../styles/SportsTable.css'; // Import CSS for SportsTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getSportInfo';

// const SportsTable = () => {
//   const [sportsData, setSportsData] = useState([]); // State variable to store sports data
...
//         setSportsData(response.data); // Assuming response.data is an array of sports data
...
//         console.log("Catch Block For Sports");
//       });
//   }
...
const URL_api = 'http://localhost:5164/getSportInfo';
const EDIT_API = 'http://localhost:5164/sports/editSports';
const DELETE_API = 'http://localhost:5164/sports/deleteSports';
