...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/sports', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/sportstable'; // Navigate to SportsTable.jsx
//   };
...
//           <h3>Sports Form</h3>
//           <form className="sports-form" onSubmit={handleSubmit}>
//             <label>Image:</label>
...
const SportsForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/sportstable'; // Navigate to HealthTable.jsx
  };
