...
// import '../styles/CommunicationTable.css'; // Import CSS for CommunicationTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getCommunicationInfo';

// const CommunicationTable = () => {
//   const [contact, setContact] = useState([]); // State variable to store communication data
...
//         setContact(response.data); // Assuming response.data is an array of communication data
...
//         <h3>Communication Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getCommunicationInfo';
const EDIT_API = 'http://localhost:5164/communication/editCommunication';
const DELETE_API = 'http://localhost:5164/communication/deleteCommunication';
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const payload = {
        eventID: "1001",
        addInfo: {
          idcommunication_data: editData.id,
