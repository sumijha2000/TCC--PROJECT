...
// import '../styles/FoodTable.css'; // Import CSS for FoodTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getFoodInfo';

// const FoodTable = () => {
//   const [foodData, setFoodData] = useState([]); // State variable to store food data
...
//         setFoodData(response.data); // Assuming response.data is an array of food data
...
//         console.log("Catch Block For Food");
//       });
//   }
...
const URL_api = 'http://localhost:5164/getFoodInfo';
const EDIT_API = 'http://localhost:5164/food/editFood';
const DELETE_API = 'http://localhost:5164/food/deleteFood';
