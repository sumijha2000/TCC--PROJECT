...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/medicine', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/medtable'; // Navigate to MedicineTable.jsx
//   };
...
const MedicineForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/medtable'; // Navigate to HealthTable.jsx
  };
