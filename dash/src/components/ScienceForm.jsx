...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/science', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/sciencetable'; // Navigate to ScienceTable.jsx
//   };
...
//           <h3>Science Form</h3>
//           <form className="science-form" onSubmit={handleSubmit}>
//             <label>Image:</label>
...
const ScienceForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/sciencetable'; // Navigate to HealthTable.jsx
  };
