...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/transportation', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/transtable'; // Navigate to TransportationTable.jsx
//   };
...
const TransportationForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/transtable'; // Navigate to HealthTable.jsx
  };
