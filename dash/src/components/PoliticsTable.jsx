...
// import '../styles/PoliticsTable.css'; // Import CSS for PoliticsTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getPoliticInfo';

// const PoliticsTable = () => {
//   const [politicsData, setPoliticsData] = useState([]); // State variable to store politics data
...
//         setPoliticsData(response.data); // Assuming response.data is an array of politics data
...
//         console.log("Catch Block For Politics");
//       });
//   }
...
//         <h3>Politics Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getPoliticInfo';
const EDIT_API = 'http://localhost:5164/politics/editPolitics';
const DELETE_API = 'http://localhost:5164/politics/deletePolitics';
