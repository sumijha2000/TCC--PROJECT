...
// import '../styles/MedicineTable.css'; // Import CSS for MedicineTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getMedInfo';

// const MedicineTable = () => {
//   const [medicineData, setMedicineData] = useState([]); // State variable to store medicine data
...
//         setMedicineData(response.data); // Assuming response.data is an array of medicine data
...
//         console.log("Catch Block For Medicine");
//       });
//   }
...
//           <h3>Medicine Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getMedInfo';
const EDIT_API = 'http://localhost:5164/medicine/editMedicine';
const DELETE_API = 'http://localhost:5164/medicine/deleteMedicine';
