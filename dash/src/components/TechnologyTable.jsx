...
// import '../styles/TechnologyTable.css'; // Import CSS for TechnologyTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getTechInfo';

// const TechnologyTable = () => {
//   const [technologyData, setTechnologyData] = useState([]); // State variable to store technology data
...
//         setTechnologyData(response.data); // Assuming response.data is an array of technology data
...
//         console.log("Catch Block For Technology");
//       });
//   }
...
//         <h3>Technology Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getTechInfo';
const EDIT_API = 'http://localhost:5164/tech/editTech';
const DELETE_API = 'http://localhost:5164/tech/deleteTech';
    ...
    try {
      const payload = {
        ...
        addInfo: {
          ...
          videos: editData.video, // Include Videos field if updated
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content">
        <Header />
        <div className="table-container">
          <h3>Technolo Inventions Table</h3>
          <table className='health-table'>
            <thead>
              <tr>
                <th>ID</th>
