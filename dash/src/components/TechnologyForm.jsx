...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/tech', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/techtable'; // Navigate to TechnologyTable.jsx
//   };
...
const TechnologyForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/techtable'; // Navigate to HealthTable.jsx
  };
        ...
        <div className="form-container">
          ...
          <form className="health-form" onSubmit={handleSubmit}>
            ...
            <option value="Software">Software</option>
              <option value="Hardware">Hardware</option>
              <option value="Internet">Internet</option>
              <option value="Telecommunications">Telecommunications</option></select>
            <br />
            <label>Description:</label>
            <textarea name="description" required value={formData.description} onChange={handleChange} />
            <br />
