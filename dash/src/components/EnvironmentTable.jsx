...
// import '../styles/EnvironmentTable.css'; // Import CSS for EnvironmentTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getEnvInfo';

// const EnvironmentTable = () => {
//   const [environmentData, setEnvironmentData] = useState([]); // State variable to store environment data
...
//         setEnvironmentData(response.data); // Assuming response.data is an array of environment data
...
//         console.log("Catch Block For EnvironmentTable");
//       });
//   }
...
//           <h3>Environment Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getEnvInfo';
const EDIT_API = 'http://localhost:5164/environment/editEnvironment';
const DELETE_API = 'http://localhost:5164/environment/deleteEnvironmenth';
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content">
        <Header />
        <div className="table-container">
          <h3>Environmenth Inventions Table</h3>
          <table className='health-table'>
            <thead>
              <tr>
                <th>ID</th>
