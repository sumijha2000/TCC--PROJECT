...
// import '../styles/CultureTable.css'; // Import CSS for CultureTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getCultureInfo';

// const CultureTable = () => {
//   const [cultureData, setCultureData] = useState([]); // State variable to store culture data
...
//         setCultureData(response.data); // Assuming response.data is an array of culture data
...
//         <h3>Culture Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getCultureInfo';
const EDIT_API = 'http://localhost:5164/culture/editCulture';
const DELETE_API = 'http://localhost:5164/culture/deleteCulture';
