...
// //     };
// //     try {
// //       const response = await axios.post('http://localhost:5164/inventions_page', payload);
...
// //   const closePopup = () => {
// //     setShowPopup(false);
// //     setPopupMessage('Add successful');
// //   };
...
// //           <h3>Economy Form</h3>
// //           <form className="economy-form" onSubmit={handleSubmit}>
// //             <label>Image:</label>
...
// //             <br />
// //             <label>Video:</label>
// //             <input type="text" name="video" required value={formData.video} onChange={handleChange} />
// //             <br />
...
// //   const closePopup = () => {
// //     setShowPopup(false);
// //     setPopupMessage(''); // Clear popup message on close
// //   };
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/economytable'; // Navigate to EconomyTable.jsx
//   };
...
const EconomyForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/economytable'; // Navigate to HealthTable.jsx
  };
