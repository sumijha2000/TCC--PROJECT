...
// import '../styles/TransportationTable.css'; // Import CSS for TransportationTable styling
// import axios from 'axios';

// const URL_api = 'http://localhost:5164/getTransInfo';

// const TransportationTable = () => {
//   const [transportationData, setTransportationData] = useState([]); // State variable to store transportation data
...
//         setTransportationData(response.data); // Assuming response.data is an array of transportation data
...
//         console.log("Catch Block For Transportation");
//       });
//   }
...
//           <h3>Transportation Inventions Table</h3>
...
const URL_api = 'http://localhost:5164/getTransInfo';
const EDIT_API = 'http://localhost:5164/transportation/editTransportation';
const DELETE_API = 'http://localhost:5164/transportation/deleteTransportation';
