...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/culture', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/culturetable'; // Navigate to CultureTable.jsx
//   };
...
//           <h3>Culture Form</h3>
//           <form className="culture-form" onSubmit={handleSubmit}>
//             <label>Image:</label>
...
const CultureForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/culturetable'; // Navigate to HealthTable.jsx
  };
