...
//     };
//     try {
//       const response = await axios.post('http://localhost:5164/politics', payload);
...
//     setShowPopup(false);
//     setPopupMessage('');
//     window.location.href = '/politictable'; // Navigate to PoliticsTable.jsx
//   };
...
//           <h3>Politics Form</h3>
//           <form className="politics-form" onSubmit={handleSubmit}>
...
const PoliticsForm = () => {
 ...
 useEffect(() => {
  ...
  const closePopupAndNavigate = () => {
    setShowPopup(false);
    setPopupMessage('');
    window.location.href = '/politictable'; // Navigate to HealthTable.jsx
  };
